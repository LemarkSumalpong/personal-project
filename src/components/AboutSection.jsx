        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 ">
            ...
            <p className="text-muted-foreground">
              ...
              applications. Skilled in troubleshooting, frontend development,
              and collaborating in team environments. Familiar with modern web
              technologies such as HTML, CSS, JavaScript, and React, with
              growing experience in UI/UX design
            </p>
            <p className="text-muted-foreground">
              Eager to apply academic knowledge and project experience to
              support organizational IT needs, while continuously learning and
              improving technical skills. Highly motivated to contribute to
              innovative projects and grow in the IT industry.
            </p>
